...
class Background(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("assets/earth.jpg")
...
class Block(pygame.sprite.Sprite):
    def __init__(self, width: int, height: int):
        ...
        self.image = pygame.image.load("assets/burger.jpeg")
...
class OptimusPrime(pygame.sprite.Sprite):
    def __init__(self):
        """The player"""
        super().__init__()

        # Right version of Mario and Left version
        self.image_right =  pygame.image.load("assets/optimus prime .jpeg")
...
class Megatron(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("assets/Megatron .jpeg")
...
def game():
  ...
  # LOAD EARTH BACKGROUND
    background = pygame.image.load("assets/beautiful-earth.jpg")
    ...
    while not done:
        ...
        # ------ DRAWING TO SCREEN
        screen.blit(background, (-200, -100)) #draw the Earth background
