...
print("Your boat makes it to land and your injured. There are two paths, to the left and right")
...
if choice1 == "left":
    ...
    if choice3 == "yes":
        if has_flashlight:
            print("with your flashlight, you explore safley and find tressure and medical supplies.")
            health +=47
            print("Ending: You escape thhe hole healed and rich!")
        else:
            print("It's pitch black... You stumble and fall. you lose 50 health making your pre-existing leg injury worse.")
            health-= 50
